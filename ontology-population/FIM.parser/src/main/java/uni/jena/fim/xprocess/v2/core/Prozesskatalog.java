...
/**
 * Eine Sammlung von Prozessklassen.
 * 
 * <p>Java class for Prozesskatalog complex type.
 * 
...
@XmlType(name = "Prozesskatalog", propOrder = {
    "name",
    "version",
    "herausgeber",
...
public class Prozesskatalog {
    ...
    protected List<Prozessklasse> prozessklasse;
    ...
    /**
     * Gets the value of the prozessklasse property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the prozessklasse property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<Prozessklasse> getProzessklasse() {
        if (prozessklasse == null) {
            prozessklasse = new ArrayList<Prozessklasse>();
        }
        return this.prozessklasse;
    }
